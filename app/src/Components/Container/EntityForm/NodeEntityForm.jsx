...
const NodeEntityForm = ({ current, setCurrent, indexedAttribute, setIndexedAttribute, columns, saveEntity, cancelSandBoxEvent, openSetModal, closeModal, removeCurrentNode}) => {
        ...
        return (
            <>
                ...
                <Flex width={"100%"} justifyContent={'end'} mt={5} gap={2}>
                    <Button size={'sm'} colorScheme="red" onClick={removeCurrentNode}>Delete</Button>
    ...
    const NodeDelete = () => {
        if(checkNodeInRelationships() === true){
            toast({
