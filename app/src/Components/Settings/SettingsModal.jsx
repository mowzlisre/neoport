...
import { Modal, ModalOverlay, ModalContent, ModalBody, Box, Flex, Divider, Button, Text, Heading, ModalFooter, InputGroup, InputLeftAddon, Input, InputRightElement, Spinner } from '@chakra-ui/react';
import { FcAcceptDatabase, FcDataEncryption, FcDatabase, FcDeleteDatabase, FcKey, FcLink, FcMindMap } from 'react-icons/fc';
import { defaultConf } from '../lib/conf';

function SettingsModal({ isOpen, onClose, dbStatus, setDbStatus }) {
            ...
            <ModalContent>
                <ModalBody p={10}>
                    <Box height={"50vh"} width={"100%"}>
                        ...
                        <Box gap={3} justifyContent={"left"} p={3}>
                            <Flex mt={3} gap={3}>
                                <InputGroup width={"70%"}>
